...
- Initial snapshot date: `2026-06-19`
- Latest local restore/update: `2026-06-23`
...
| --- | --- | --- | --- | --- | --- |
| `automation` | 实时公开来源与机构研究监控 | Monday-Friday 20:30 | Beijing / Asia-Shanghai | Realtime public-source and institutional-research monitor feeding the open-prep and intraday review workflows. | [`automation/automation.toml`](automation/automation.toml) |
...
## Backed Up But Not Currently Installed

These configs are kept for restore/reference but were not present in the live local Codex automation store during the latest check:

| ID | Name | Previous schedule | Purpose | Config |
| --- | --- | --- | --- | --- |
| `automation-2` | 美股开盘资讯与个股操作建议 | Monday-Friday 21:30 | U.S. stock open prep: public-source checks, institutional research deltas, watchlist review, quote/K-line validation, and candidate operation checklist. | [`automation-2/automation.toml`](automation-2/automation.toml) |
