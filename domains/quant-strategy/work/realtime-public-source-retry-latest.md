...
Run time: 2026-07-10T13:25:49.273Z (2026/07/10 21:25:49 Beijing)
Since: 2026-07-10T12:45:00.000Z (2026/07/10 20:45:00 Beijing)

## Summary

| Source | Status | New verified items | Dimension | Evidence | Note |
| --- | --- | ---: | --- | --- | --- |
| @nvidia | 未取得可采信新内容 | 0 | AI 算力/推理/产品路线 | 低 | 账号页可读；已按 status 详情和 snowflake 时间筛选。 |
| @elonmusk | 未取得可采信新内容 | 0 | xAI/Tesla/SpaceX/AI 基建 | 低 | Jina Reader 未能读取账号页。 |
| @realDonaldTrump | 未取得可采信新内容 | 0 | 政策/关税/地缘风险 | 低 | Jina Reader 未能读取账号页。 |
...
Diagnostics:
- jina_profile: ok=true status=200 length=20978
- jina_status id=2075311533190455594: ok=true status=200 length=1200
- jina_status id=2075293913213018544: ok=true status=200 length=2960
- jina_status id=2075293919651168600: ok=true status=200 length=0
- jina_status id=2075283846657175683: ok=true status=200 length=0
- jina_status id=2075248918011801686: ok=true status=200 length=0
...
Diagnostics:
- raw_profile_html: ok=true status=200 length=945767
