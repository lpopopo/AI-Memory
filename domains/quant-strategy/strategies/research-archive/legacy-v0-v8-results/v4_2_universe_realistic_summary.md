# V4.2 Realistic Full-Universe Strategy Backtest Summary

This version incorporates strict real-world constraints to address potential survivorship bias and execution friction.

## Real-World Constraints Added (V4.2)

- **T+1 Execution Delay**: Signals generated at month-end close are executed at the next day's close. Eliminates look-ahead bias.
- **Transaction Costs**: Applied 0.1% cost per side (0.2% round-trip) based on portfolio turnover at each rebalance.
- **Minimum Price Threshold**: Stocks must be priced >= $5 to avoid penny stock volatility/liquidity issues.
- **Minimum History**: Stocks must have at least 252 trading days of history to avoid new IPO anomalies.

## Configuration

- Strategy Name: `dual_sleeve_v4_2_universe_realistic`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Dual Sleeve V4.2 Realistic | 88.191 | 18.81% | -57.28% | 23.44% | 0.85 | 1.14 |
...
| --- | --- | ---: | ---: | ---: | ---: |
| full_26yr | Dual Sleeve V4.2 Realistic | 88.191 | 18.81% | -57.28% | 0.85 |
| full_26yr | SPY | 7.499 | 8.06% | -55.19% | 0.50 |
| full_26yr | QQQ | 7.740 | 8.19% | -82.96% | 0.43 |
| full_26yr | 50/50 SPY/QQQ | 8.145 | 8.40% | -68.87% | 0.47 |
| dotcom_crash_2000_2002 | Dual Sleeve V4.2 Realistic | 0.667 | -12.66% | -37.48% | -0.64 |
...
| bull_market_2003_2007 | Dual Sleeve V4.2 Realistic | 3.141 | 25.75% | -16.64% | 1.20 |
...
| financial_crisis_2008 | Dual Sleeve V4.2 Realistic | 0.630 | -37.05% | -47.21% | -0.90 |
...
| bull_market_2009_2019 | Dual Sleeve V4.2 Realistic | 7.629 | 20.30% | -30.00% | 0.96 |
...
| covid_crash_2020 | Dual Sleeve V4.2 Realistic | 1.701 | 70.46% | -30.27% | 1.71 |
...
| bull_market_2021 | Dual Sleeve V4.2 Realistic | 1.380 | 38.53% | -13.44% | 1.45 |
...
| inflation_bear_2022 | Dual Sleeve V4.2 Realistic | 0.944 | -5.69% | -20.91% | -0.14 |
...
| bull_market_2023_2025 | Dual Sleeve V4.2 Realistic | 3.707 | 55.00% | -29.37% | 1.91 |
